...
const { crearGiftCard, obtenerGiftCards, obtenerGiftCardsActivas, actualizarGiftCard, eliminarGiftCard } = require('../controladores/cardControlador');
...
router.delete('/:id', verificarToken, esAdmin, eliminarGiftCard);//Protegido por rol
